...
### Example 3 - Place sliced lettuce into a bin
__Result__: Failure

<iframe width="1200" height="600" src="https://www.youtube.com/embed/utDbnoOX9fM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

# Predicted vs Ground-truth Segmentation and Depth
### Example 4A - Put a clean bar of soap in a cabinet
__Result__: Success
...
### Example 4B (ground truth depth and segmentation) - Put a clean bar of soap in a cabinet
__Result__: Failure
...
Perfect depth and segmentation in Example 4B results in clear semantic voxel maps. As a result, the agent knows perfectly the location of every observed object, and succeeds in most interaction actions with the first attempt.
